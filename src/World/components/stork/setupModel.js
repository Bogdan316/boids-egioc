...
class Boid extends Object3D {
  constructor(model, clip) {
    super();

    this.model = model.clone();

    this.velocity = new Vector3(getRandomNum(100, -100) * 0.1, getRandomNum(100, -100) * 0.1, getRandomNum(100, -100) * 0.1);;
    this.boost = new Vector3(0, 0, 0);
    this.acceleration = new Vector3(this.model);
    ...
    const theta = MathUtils.degToRad(getRandomNum(180));
    const phi = MathUtils.degToRad(getRandomNum(360));
